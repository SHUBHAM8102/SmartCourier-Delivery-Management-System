...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .servers(List.of(new Server().url(serverUrl).description("Tracking Service")))
                .info(new Info()
                        .title("SmartCourier Tracking Service API")
                        .version("1.0.0")
                        .description("API for tracking shipments, managing documents, and capturing delivery proofs")
                        .contact(new Contact()
